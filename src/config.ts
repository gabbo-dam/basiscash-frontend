...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    defaultProvider: 'https://goerli.infura.io/v3/e7eb51860d1d4bddad5b6d9f31d4c190',
    ...
    baseLaunchDate: new Date('2021-01-17T23:00:00Z'),
    bondLaunchesAt: new Date('2020-01-23T00:00:00Z'),
    boardroomLaunchesAt: new Date('2021-01-29T00:00:00Z'),
